...
let
  ...
  legacyAppPath = "/Applications/Identity Enterprise.app";
  stampPath = "/var/db/unifi-identity-enterprise-store-path";
  bundleId = "com.ui.uid.desktop";
  helper = "com.ui.uid.desktop.privilegedtool";
  helperSrc = "${appPath}/Contents/XPCServices/UIAgentXPC.xpc/Contents/Library/LaunchServices/${helper}";
  ...
  app = "${pkgs.unifi-identity-enterprise}/Applications/${appName}";
in
{
